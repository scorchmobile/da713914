class TestimonialsController < ApplicationController
  ...
  def index
    @testimonials = Testimonial.all.order(testimonial_type: :asc, position: :asc)
  end
  ...
  def destroy
    @testimonial.destroy
    respond_to do |format|
      format.html { redirect_to testimonials_path, notice: 'Testimonial was successfully destroyed.' }
  ...
  private
    ...
    def testimonial_params
      params.require(:testimonial).permit(:image, :author, :content, :css_bottom, :css_left, :testimonial_type, :position)
    end
end
